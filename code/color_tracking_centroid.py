...
while True:
    ...
    if len(cnts) > 0:
    	...
    	# will assume this contour correspondes to the area of the marker cap
    ...
    # Append the next deque when no contours are detected (i.e., marker cap reversed)
    else:
	...
	# If the 'z' key is pressed, stop the loop
    ...
    if key == ord("z"):
        ...
        cv2.imshow("Saved Drawing", img)
        cv2.waitKey(2000)  # Show for 2 seconds
        cv2.destroyWindow("Saved Drawing")
